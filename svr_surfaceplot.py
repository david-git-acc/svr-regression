...
points_below = ax.scatter(scatter_x[below], scatter_y[below], z[below], s=32, edgecolor="black", c="cyan", label="Original points")
...
points_above = ax.scatter(scatter_x[above], scatter_y[above], z[above], s=32, edgecolor="black", c="cyan")
